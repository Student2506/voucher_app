    ...
    <>
      {
        orders.map((order) =>
          <RadioFake
            value={order.order_items.voucher_attached.voucher_type_id}
            key={order.order_items.voucher_attached.voucher_type_id}
            id={order.order_items.voucher_attached.voucher_type_id}
