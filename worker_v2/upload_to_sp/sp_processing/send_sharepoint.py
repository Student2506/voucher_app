...
class SharePoint:
    ...
    def __init__(self) -> None:
        self.conn = ClientContext(settings.sharepoint_site).with_credentials(
    ...
    def create_folder(self, folder_name: str) -> Any:
        ...
        target_folder_url_path = Path('/sites') / settings.sharepoint_site_name / settings.sharepoint_doc_library
        root_folder = self.conn.web.get_folder_by_server_relative_url(target_folder_url_path.as_posix())
